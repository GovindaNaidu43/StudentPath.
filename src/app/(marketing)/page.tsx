      ...
      <section className="relative z-10 overflow-hidden bg-gradient-to-b from-black via-[#0e0728] to-[#180a38] pt-20 pb-36 text-white">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 md:px-12 text-center">
          <span className="inline-flex items-center gap-2 rounded-full border border-fuchsia-400/50 bg-fuchsia-500/20 px-5 py-2 text-xs font-black uppercase tracking-[0.3em] text-fuchsia-300 shadow-[0_0_30px_rgba(217,70,239,0.4)] mb-8 backdrop-blur-md">
            âœ¨ Built For The Next Generation
          </span>
          ...
          <div className="mt-12 flex flex-wrap items-center justify-center gap-4">
            {[
              { label: "ðŸš€ 500+ Career Paths", color: "border-fuchsia-400/50 bg-fuchsia-500/20 text-fuchsia-200 shadow-[0_0_20px_rgba(217,70,239,0.3)]" },
              { label: "ðŸ¤– 24/7 AI Mentor", color: "border-cyan-400/50 bg-cyan-500/20 text-cyan-200 shadow-[0_0_20px_rgba(34,211,238,0.3)]" },
              { label: "âš¡ Live Salary & Demand Insights", color: "border-amber-400/50 bg-amber-500/20 text-amber-200 shadow-[0_0_20px_rgba(251,191,36,0.3)]" },
              { label: "ðŸŽ¯ Personalized Skill Roadmaps", color: "border-emerald-400/50 bg-emerald-500/20 text-emerald-200 shadow-[0_0_20px_rgba(52,211,153,0.3)]" },
            ].map((stat) => (
              <span
                key={stat.label}
