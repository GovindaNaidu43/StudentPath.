...
export default function AdminCareerForm({ career }: Props) {
  ...
  /* â”€â”€â”€ Stable key helper â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
  // Each array item gets a stable _key so we never use key={index}.
  // This is the fix for "typing one character loses focus".
  function stableKey() {
    return `${Date.now()}-${Math.random().toString(36).slice(2, 7)}`;
  }

  function withKeys(arr: any[]) {
    return (arr || []).map((item: any) =>
      item._key ? item : { ...item, _key: stableKey() }
    );
  }
  ...
  const [formData, setFormData] = useState(() => ({
    ...
    insights: withKeys(career.career_insights),
    whyExists: withKeys(career.career_why_exists),
    scenes: withKeys(career.career_scenes),
    pathSteps: withKeys(career.career_path_steps),
    future_roles: withKeys(career.future_roles),
  }));

  /* â”€â”€â”€ Field helpers (unchanged) â”€â”€â”€â”€â”€â”€â”€ */
  ...
  /* â”€â”€â”€ Insights (unchanged) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
  ...
  /* â”€â”€â”€ Why Exists (unchanged) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
  ...
  /* â”€â”€â”€ Scenes â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
  ...
  /* â”€â”€â”€ Path Steps â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
  ...
  /* â”€â”€â”€ Future Roles â”€â”€â”€â”€â”€â”€â”€â”€ */
  ...
  function addFutureRole() {
    setFormData((prev) => ({
      ...
      future_roles: [
        ...prev.future_roles,
        { _key: stableKey(), role_name: "", short_description: "", image_url: "" },
      ],
    }));
  }
  ...
  /* â”€â”€â”€ Form submit (unchanged) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
  ...
  /* â”€â”€â”€ Save status UI helpers â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
  ...
  /* â”€â”€â”€ Save button â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
  ...
  /* â”€â”€â”€ Render â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex flex-1 min-h-0">
        ...
        {/* â”€â”€ DESKTOP LEFT SIDEBAR â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
        ...
        {/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
            MAIN CONTENT PANEL â€” SINGLE FORM
        â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */}
...
>
            ...
            {/* â”€â”€ ALWAYS-MOUNTED HIDDEN FIELDS â”€â”€ */}
            ...
            >
              ...
              <div className="mb-8">
                ...
                <textarea
                  ...
                  placeholder="Describe the emotional vision, mission, and future potential of this careerâ€¦"
                />
              </div>
                  ...
                  >
                    ...
                    <div className="mb-4">
                      ...
                      <textarea
                        ...
                        rows={3}
                        className={textareaCls}
                        placeholder="Brief description visible on the cardâ€¦"
                      />
                    </div>
                    <div>
                      ...
                      <textarea
                        ...
                        rows={5}
                        className={textareaCls}
                        placeholder="Full expanded detail shown when the card is openedâ€¦"
                      />
                    </div>
                  </CardShell>
                ))}
                  ...
                  >
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        rows={6}
                        className={textareaCls}
                        placeholder="Explain why this career matters and how it came to beâ€¦"
                      />
                    </div>
                  </CardShell>
                ))}
                  ...
                  >
                    ...
                    <div className="mb-5">
                      ...
                      <textarea
                        ...
                        rows={4}
                        className={textareaCls}
                        placeholder="Describe the scene students will visualizeâ€¦"
                      />
                    </div>
                    <div>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        rows={4}
                        className={textareaCls}
                        placeholder="Describe what students do in this stepâ€¦"
                      />
                    </div>
                  </CardShell>
                ))}
                  ...
                  >
                    ...
                    <div className="mb-5">
                      ...
                      <textarea
                        ...
                        rows={4}
                        className={textareaCls}
                        placeholder="Describe this future opportunityâ€¦"
                      />
                    </div>
                    <div>
        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-3">
              ...
              >
                {isDeleting ? "Deletingâ€¦" : "Delete Career"}
              </button>
            </div>
          </div>
        </div>
